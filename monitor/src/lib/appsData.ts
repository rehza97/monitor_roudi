...
export const appsData: Record<string, AppData> = {
  "ecotrack-pro": {
    ...
    features: [
      { icon: "eco",              iconBg: "bg-emerald-100", iconColor: "text-emerald-600", title: "Bilan Carbone Auto",    desc: "Calcul automatique de vos émissions Scope 1, 2 et 3 selon les référentiels GHG Protocol." },
      { icon: "monitoring",       iconBg: "bg-blue-100",       iconColor: "text-blue-600",    title: "Tableau de bord ESG",   desc: "Vue consolidée de tous vos indicateurs environnementaux, sociaux et de gouvernance." },
      { icon: "description",      iconBg: "bg-amber-100",     iconColor: "text-amber-600",   title: "Rapports CSRD",         desc: "Génération automatique des rapports conformes à la directive européenne CSRD." },
      { icon: "notifications_active", iconBg: "bg-rose-100",   iconColor: "text-rose-600",    title: "Alertes de seuil",      desc: "Notifications en temps réel dès qu'un indicateur dépasse les objectifs fixés." },
    ],
    hardware: [
  ...
  "devmonitor-x": {
    ...
    features: [
      { icon: "speed",         iconBg: "bg-indigo-100",  iconColor: "text-indigo-600",  title: "Métriques temps réel", desc: "CPU, RAM, réseau, disque — collecte toutes les 10 secondes avec rétention 13 mois." },
      { icon: "bug_report",    iconBg: "bg-rose-100",      iconColor: "text-rose-600",    title: "APM intégré",          desc: "Traces distribuées et profiling applicatif pour identifier les goulets d'étranglement." },
      { icon: "warning",       iconBg: "bg-amber-100",    iconColor: "text-amber-600",   title: "Alertes intelligentes",desc: "Détection d'anomalies par ML — moins de faux positifs, plus de réactivité." },
      { icon: "integration_instructions", iconBg: "bg-blue-100", iconColor: "text-blue-600", title: "200+ intégrations", desc: "Slack, PagerDuty, Jira, GitHub Actions, Kubernetes, Prometheus et bien plus." },
    ],
    hardware: [
  ...
  "dataviz-suite": {
    ...
    features: [
      { icon: "bar_chart",     iconBg: "bg-blue-100",      iconColor: "text-blue-600",   title: "50+ types de graphiques", desc: "Barres, courbes, cartes géo, heatmaps, sankey — tous personnalisables." },
      { icon: "database",      iconBg: "bg-indigo-100",  iconColor: "text-indigo-600", title: "Connecteurs universels", desc: "PostgreSQL, MySQL, BigQuery, Snowflake, Google Sheets, CSV, API REST." },
      { icon: "groups",        iconBg: "bg-emerald-100",iconColor: "text-emerald-600",title: "Collaboration temps réel", desc: "Partagez et co-éditez vos tableaux de bord avec toute l'équipe." },
      { icon: "schedule",      iconBg: "bg-amber-100",    iconColor: "text-amber-600",  title: "Rapports planifiés",      desc: "Envoi automatique de PDF ou emails à vos stakeholders selon planning." },
    ],
    hardware: [
  ...
  "securegate": {
    ...
    features: [
      { icon: "key",           iconBg: "bg-slate-100",   iconColor: "text-slate-700", title: "SSO / OAuth2",          desc: "Connexion unique sur toutes vos applications internes avec standards ouverts." },
      { icon: "phonelink_lock",iconBg: "bg-blue-100",  iconColor: "text-blue-600",                      title: "MFA adaptatif",          desc: "TOTP, SMS, passkey et biométrie selon le niveau de risque détecté." },
      { icon: "manage_accounts",iconBg:"bg-indigo-100",iconColor:"text-indigo-600",                    title: "Directory as a Service", desc: "Gestion centralisée des utilisateurs, rôles et permissions via interface admin." },
      { icon: "shield",        iconBg: "bg-emerald-100",iconColor:"text-emerald-600",                title: "Audit & conformité",     desc: "Logs d'accès complets, rapports LPD, export SIEM." },
    ],
    hardware: [
