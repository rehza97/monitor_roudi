...
const statusColors: Record<string, string> = {
  ...
  "Annulé":     "text-rose-700 bg-rose-50",
}
...
export default function EngineerProjects() {
  ...
  const kpis = [
    { label: "En cours",   value: enCours,   icon: "sync",       color: "text-blue-600",    bg: "bg-blue-50" },
    { label: "Validées",   value: validees,  icon: "check",      color: "text-emerald-600", bg: "bg-emerald-50" },
    { label: "Livrés", value: livres, icon: "inventory_2", color: "text-amber-600",  bg: "bg-amber-50" },
  ]
