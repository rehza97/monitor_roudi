    ...
    <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2 text-sm rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-[#db143c] resize-none"
        />
      </div>
        ...
        {engineer && !loading && (
          <>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-5">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-3">
                    <h2 className="text-xl font-bold text-slate-900">{engineer.name}</h2>
                    <span
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { label: "Projets actifs", value: String(engineer.projects), icon: "folder_open", color: "text-blue-600 bg-blue-50" },
                { label: "Statut", value: engineer.status, icon: "circle", color: statusColor[engineer.status] ?? "text-slate-600 bg-slate-100" },
                { label: "Spécialité", value: engineer.specialty, icon: "code", color: "text-violet-600 bg-violet-50" },
                {
                  label: "Compte lié",
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm font-semibold text-slate-900 truncate">{s.value}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
              <div className="flex items-center gap-2 pb-1 border-b border-slate-100">
                ...
                <h3 className="font-semibold text-slate-900">Modifier le profil</h3>
              </div>
