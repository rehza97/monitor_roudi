...
const fallbackJobs: JobRow[] = [
  { title: "Senior Backend Engineer",     team: "Engineering", location: "Alger (hybride)",  type: "CDI",        badge: "Nouveau",  badgeColor: "text-emerald-700 bg-emerald-50" },
  { title: "Lead Frontend React",         team: "Engineering", location: "Alger / Remote",   type: "CDI",        badge: null,       badgeColor: "" },
  { title: "DevOps / SRE",                team: "Infra",       location: "Oran (full remote)",type: "CDI",       badge: "Urgent",   badgeColor: "text-rose-700 bg-rose-50" },
  ...
  { title: "Stage — Développeur FullStack",team: "Engineering",location: "Alger",            type: "Stage 6 mois",badge: "Stage",   badgeColor: "text-blue-700 bg-blue-50" },
]
    ...
    <PublicLayout>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-8">Offres d'emploi</h2>
          <div className="space-y-4">
            {jobs.map(j => (
              <div key={j.title} className="bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group">
                <div className="flex items-center justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-semibold text-slate-900 group-hover:text-blue-600 transition-colors">{j.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {perks.map(p => (
              <div key={p.title} className="flex items-start gap-4 p-5 bg-slate-50 rounded-xl border border-slate-100">
      ...
      <section className="py-16 bg-blue-50 border-y border-blue-100">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold text-slate-900 mb-3">Vous ne trouvez pas votre poste ?</h3>
          <p className="text-slate-600 mb-6">Envoyez-nous une candidature spontanée — nous lisons chaque message.</p>
