              ...
              {user ? (
                <>
                  <Link
                    ...
                    className="flex items-center justify-center h-9 px-4 text-sm font-medium text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors"
                  >
                    Tableau de bord
                  </Link>
                  <button
                ...
                <>
                  <Link to="/login" className="hidden sm:flex items-center justify-center h-9 px-4 text-sm font-medium text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors">
                    Connexion
                  </Link>
      ...
      <footer className="bg-white border-t border-slate-200 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            {/* Produits */}
            <div>
              <h4 className="font-bold text-slate-900 mb-4 text-sm uppercase tracking-wider">Produits</h4>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={to}>
                    <Link className="text-sm text-slate-500 hover:text-blue-600 transition-colors" to={to}>
                      {label}
                    </Link>
                  </li>
                ))}
            ...
            {/* Entreprise */}
            <div>
              <h4 className="font-bold text-slate-900 mb-4 text-sm uppercase tracking-wider">Entreprise</h4>
              <ul className="space-y-3">
                {[
                  { to: "/about",   label: "À propos"  },
            ...
            {/* Légal */}
            <div>
              <h4 className="font-bold text-slate-900 mb-4 text-sm uppercase tracking-wider">Légal</h4>
              <ul className="space-y-3">
                {[
